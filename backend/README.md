...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **`s5`** | **Dual Momentum Leader v1.2.0** | **Rotación Multi-Sectorial + Metales** | 14 activos: `SPY`, `QQQ`, `AAPL`, `MSFT`, `NVDA`, `AMZN`, `META`, `GOOGL`, `JPM`, `LLY`, `XOM`, `COST`, `GLD`, `SLV` | 15:45 | **Motor primario de Alpha (bate al S&P 500 con +81.85% vs +15.70%, Sharpe 2.91, MaxDD -7.57%, WinRate 71.4%, PF 5.28).** Selecciona los 2 líderes con mayor momentum a 45 días sobre la EMA25. Trailing Stop en EMA25, rotación 100% a efectivo remunerado (T-Bills 4.5% anual) en regímenes bajistas, filtro FinBERT y soporte de proxies (`GLDM`). |
